...
local AccommodationSDK = {}
AccommodationSDK.__index = AccommodationSDK
...
AccommodationSDK._make_feature = _make_feature


function AccommodationSDK.new(options)
  local self = setmetatable({}, AccommodationSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function AccommodationSDK:options_map()
...
function AccommodationSDK:get_utility()
  return Utility.copy(self._utility)
end


function AccommodationSDK:get_root_ctx()
  return self._rootctx
end


function AccommodationSDK:prepare(fetchargs)
...
function AccommodationSDK:direct(fetchargs)
...
-- by passing it.
function AccommodationSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function AccommodationSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "AccommodationSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function AccommodationSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = AccommodationSDK.new(sdkopts)
  sdk.mode = "test"
