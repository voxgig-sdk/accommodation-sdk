...
The Lua SDK for the Accommodation API. Provides an entity-oriented interface using Lua conventions.
...
```lua
local result, err = client:Accommodation(nil):list(nil, nil)
