...
describe("AccommodationDirect", function()
  it("should direct-list-accommodation", function()
    local setup = accommodation_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-accommodation", setup.live and "live" or "unit")
...
function accommodation_direct_setup(mockres)
