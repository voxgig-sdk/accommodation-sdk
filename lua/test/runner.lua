...
function runner.env_override(m)
  local live = runner.getenv("ACCOMMODATION_TEST_LIVE")
  local override = runner.getenv("ACCOMMODATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ACCOMMODATION_TEST_EXPLAIN")
