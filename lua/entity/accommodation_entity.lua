-- Accommodation SDK Accommodation entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AccommodationEntity = {}
AccommodationEntity.__index = AccommodationEntity


function AccommodationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AccommodationEntity)
  self._name = "accommodation"
  self._client = client
...
function AccommodationEntity:get_name()
  return self._name
end


function AccommodationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AccommodationEntity.new(self._client, opts)
end
...
function AccommodationEntity:mark_deleted()
  self._deleted = true
end


function AccommodationEntity:deleted()
  return true == self._deleted
end


function AccommodationEntity:data_set(args)
  if args ~= nil then
...
function AccommodationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AccommodationEntity:match_set(args)
  if args ~= nil then
...
function AccommodationEntity:match_get()
...
function AccommodationEntity:stream(action, args, callopts)
...
function AccommodationEntity:_run_op(ctx, post_done)
  local utility = self._utility
