// Command Accommodation-mcp is an MCP server exposing the Accommodation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Accommodation_list  — list records of an entity
//	Accommodation_load  — load a single record of an entity
//
