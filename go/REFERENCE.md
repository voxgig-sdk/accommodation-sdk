# Accommodation Golang SDK Reference

Complete API reference for the Accommodation Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *AccommodationSDK`
...
#### `Accommodation(data map[string]any) AccommodationEntity`

Create a new `Accommodation` entity instance. Pass `nil` for no initial data.
