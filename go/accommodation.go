...
// instead of `sdk.NewAccommodationSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *AccommodationSDK  { return NewAccommodationSDK(nil) }
func Test() *AccommodationSDK { return TestSDK(nil, nil) }
