...
function envOverride(m) {
    if ('TRUE' === process.env.ACCOMMODATION_TEST_LIVE ||
        'TRUE' === process.env.ACCOMMODATION_TEST_OVERRIDE) {
    ...
    m.ACCOMMODATION_TEST_EXPLAIN = process.env.ACCOMMODATION_TEST_EXPLAIN || m.ACCOMMODATION_TEST_EXPLAIN;
    return m;
}
