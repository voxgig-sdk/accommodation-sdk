...
(0, node_test_1.describe)('AccommodationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AccommodationSDK({
    ...
    (0, node_test_1.test)('direct-list-accommodation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-accommodation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ACCOMMODATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AccommodationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ACCOMMODATION_TEST_ACCOMMODATION_ENTID'];
    ...
    const client = new __1.AccommodationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AccommodationDirect.test.js.map