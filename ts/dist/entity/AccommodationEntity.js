...
class AccommodationEntity extends AccommodationEntityBase_1.AccommodationEntityBase {
    constructor(client, entopts) {
        ...
        this.name_ = 'accommodation';
        this.Name = 'Accommodation';
    }
    make() {
        return new AccommodationEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Accommodation[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.AccommodationEntity = AccommodationEntity;
//# sourceMappingURL=AccommodationEntity.js.map