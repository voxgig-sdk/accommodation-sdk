# Accommodation TypeScript SDK



The TypeScript SDK for the Accommodation API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Accommodation()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `AccommodationSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `AccommodationSDK.test(testopts?, sdkopts?)` | `AccommodationSDK` | Create a test-mode client. |
...
| `client` | `client(): AccommodationSDK` | Return the parent SDK client. |
...
accommodation/
├── src/
│   ├── AccommodationSDK.ts        # Main SDK class
