# Accommodation PHP SDK Reference

Complete API reference for the Accommodation PHP SDK.
...
#### `AccommodationSDK::test($testopts = null, $sdkopts = null)`
