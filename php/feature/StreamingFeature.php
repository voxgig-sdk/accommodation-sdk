...
// Accommodation SDK streaming feature
...
class AccommodationStreamingFeature extends AccommodationBaseFeature
{
    ...
    private function _iterate(AccommodationResult $result): \Generator
    {
    ...
    private function _streamable(AccommodationContext $ctx): bool
    {
