...
// Accommodation SDK telemetry feature
...
class AccommodationTelemetryFeature extends AccommodationBaseFeature
{
    ...
    private function _close(AccommodationContext $ctx, bool $ok): void
    {
