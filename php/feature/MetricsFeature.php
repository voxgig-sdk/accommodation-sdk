...
// Accommodation SDK metrics feature
...
class AccommodationMetricsFeature extends AccommodationBaseFeature
{
    ...
    private function _record(AccommodationContext $ctx, bool $ok): void
    {
