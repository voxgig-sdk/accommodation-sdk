...
// Accommodation SDK audit feature
...
class AccommodationAuditFeature extends AccommodationBaseFeature
{
    ...
    private function _emit(AccommodationContext $ctx, string $outcome): void
    {
