...
// Accommodation SDK clienttrack feature
...
class AccommodationClienttrackFeature extends AccommodationBaseFeature
{
    ...
    public function PostConstruct(AccommodationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Accommodation-SDK';
