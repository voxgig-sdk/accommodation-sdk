...
// Accommodation SDK timeout feature
...
class AccommodationTimeoutFeature extends AccommodationBaseFeature
{
    ...
    private function _with_timeout(AccommodationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AccommodationContext $_ctx, float $ms): void
    {
        $client = $this->client;
