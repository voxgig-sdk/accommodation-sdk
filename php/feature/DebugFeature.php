...
// Accommodation SDK debug feature
...
class AccommodationDebugFeature extends AccommodationBaseFeature
{
    ...
    private function _finish(AccommodationContext $ctx, bool $ok): void
    {
