...
// Accommodation SDK netsim feature
...
class AccommodationNetsimFeature extends AccommodationBaseFeature
{
    ...
    private function _simulate(AccommodationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AccommodationContext $ctx, array $applied): void
    {
        $client = $this->client;
