...
class AccommodationSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = AccommodationHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = AccommodationHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!AccommodationFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, AccommodationFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return AccommodationUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = AccommodationHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = AccommodationHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = AccommodationHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new AccommodationError($op . "_allow",
                "AccommodationSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = AccommodationHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new AccommodationError("graphql_error",
                "AccommodationSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Accommodation($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_accommodation === null) {
                $this->_accommodation = new AccommodationEntity($this, null);
            }
            return $this->_accommodation;
        }
        return new AccommodationEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new AccommodationSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
