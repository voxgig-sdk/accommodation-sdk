...
// Accommodation SDK utility type

class AccommodationUtility
{
    ...
    public static function copy(AccommodationUtility $src): AccommodationUtility
    {
        $u = new AccommodationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
