...
// Accommodation SDK pipeline test
//
...
{
    private static function utility(): AccommodationUtility
    {
        return new AccommodationUtility();
    }
    ...
    private static function ctx(array $over = []): AccommodationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AccommodationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AccommodationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AccommodationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AccommodationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AccommodationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AccommodationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AccommodationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AccommodationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AccommodationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AccommodationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AccommodationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AccommodationResponse([]),
            'result' => new AccommodationResult([]),
        ]);
        [, $err] = AccommodationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AccommodationSpec([]),
            'response' => null,
            'result' => new AccommodationResult([]),
        ]);
        [, $err] = AccommodationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AccommodationSpec(['step' => 's']),
            'response' => new AccommodationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AccommodationResult([]),
        ]);
        [, $err] = AccommodationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AccommodationSpec(['step' => 's']),
            'response' => new AccommodationResponse(self::resp(200, ['v' => 1])),
            'result' => new AccommodationResult([]),
        ]);
        [, $err] = AccommodationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AccommodationSpec(['step' => 's']),
            'response' => new AccommodationResponse(self::resp(200, ['v' => 2])),
            'result' => new AccommodationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AccommodationMakeResponse::call($ctx);
    ...
    {
        $preset = new AccommodationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AccommodationSpec([]),
            'response' => new AccommodationResponse([]),
            'result' => new AccommodationResult([]),
        ...
        [$got, $err] = AccommodationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AccommodationResult([])]);
        [, $err] = AccommodationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AccommodationSpec([]), 'result' => null]);
        [, $err] = AccommodationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AccommodationSpec(['step' => 's']),
            'result' => new AccommodationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AccommodationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AccommodationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AccommodationSpec(['step' => 's']),
            'result' => new AccommodationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AccommodationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AccommodationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AccommodationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AccommodationSpec([]),
            'result' => new AccommodationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AccommodationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AccommodationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AccommodationError('boom', 'boom');
        $utility->fetcher = function (AccommodationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AccommodationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AccommodationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AccommodationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AccommodationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AccommodationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AccommodationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AccommodationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AccommodationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AccommodationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AccommodationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AccommodationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AccommodationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AccommodationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AccommodationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AccommodationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AccommodationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AccommodationResult(['ok' => false])]);
        $this->expectException(AccommodationError::class);
        AccommodationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AccommodationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AccommodationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AccommodationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AccommodationBaseFeature();
        $b = new AccommodationBaseFeature();
        AccommodationFeatureAdd::call($ctx, $a);
        AccommodationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AccommodationBaseFeature
    {
        $f = new AccommodationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AccommodationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?AccommodationSpec $spec): AccommodationContext
    {
    ...
    private static function auth_bags(): AccommodationSpec
    {
        return new AccommodationSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        AccommodationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AccommodationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AccommodationResponse(['headers' => null]),
            'result' => new AccommodationResult([]),
        ]);
        AccommodationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AccommodationResultBody::call($ctx);
