...
class AccommodationTestRunner
{
    ...
    {
        $live = self::getenv('ACCOMMODATION_TEST_LIVE');
        $override = self::getenv('ACCOMMODATION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ACCOMMODATION_TEST_EXPLAIN');
...
class_alias('AccommodationTestRunner', 'Runner');
class_alias('AccommodationHelpers', 'Helpers');
