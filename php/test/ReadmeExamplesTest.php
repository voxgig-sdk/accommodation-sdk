...
// Accommodation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AccommodationSDK::test)
...
{
    private const SDK_CLASS = 'AccommodationSDK';
    ...
    private const SDK_BASE = 'accommodation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../accommodation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
