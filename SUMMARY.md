...
Results: Successful response with accommodation data.
...
- `AccoTypeId`: Type identifier (for example, hotel, guesthouse)
...
| --- | --- | --- | --- |
| Accommodation | `list` | `GET /Accommodation` | See reference |

## Connect to the API

- Open Data Hub Tourism API Server: `https://tourism.opendatahub.com/api`
...
- `accommodation_list`: List records for an entity. Supported entities: `accommodation`.
- `accommodation_load`: Load one record for an entity. No active entity supports this operation.
