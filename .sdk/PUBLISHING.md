...
|---|---|---|
| `ts/` | @voxgig-sdk/accommodation-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/accommodation-sdk \
      --repository voxgig-sdk/accommodation-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/accommodation-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/accommodation-sdk --id=<id>` removes one.
