...
class AccommodationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AccommodationTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AccommodationTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AccommodationTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
