...
_runner = makeRunner(TEST_JSON_FILE, AccommodationSDK.test(None, None))
...
def _auth_credential():
    ...
    ctx.spec = AccommodationSpec({"headers": {}, "query": {}})
    try:
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AccommodationSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AccommodationSDK.test(None, setup.get('a') or {})
