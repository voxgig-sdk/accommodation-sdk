# Accommodation SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, AccommodationError):
        errmsg = err.msg
    ...
    msg = "AccommodationSDK: " + opname + ": " + errmsg
    ...
    sdk_err = AccommodationError("", msg, ctx)
