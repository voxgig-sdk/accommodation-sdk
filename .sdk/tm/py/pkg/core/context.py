...
from projectname_sdk.core.control import AccommodationControl
...
class AccommodationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AccommodationControl()
        ...
        if isinstance(sp, AccommodationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AccommodationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AccommodationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AccommodationError(code, msg, self)
