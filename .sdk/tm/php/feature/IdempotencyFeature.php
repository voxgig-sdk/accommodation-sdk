...
// Accommodation SDK idempotency feature
...
class AccommodationIdempotencyFeature extends AccommodationBaseFeature
{
    ...
    private function _mutating(AccommodationContext $ctx): bool
    {
