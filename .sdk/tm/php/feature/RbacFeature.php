...
// Accommodation SDK rbac feature
...
class AccommodationRbacFeature extends AccommodationBaseFeature
{
    ...
    private function _required(AccommodationContext $ctx): ?string
    {
    ...
    private function _reject(AccommodationContext $ctx, string $required): void
    {
    ...
    private function _track(AccommodationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
