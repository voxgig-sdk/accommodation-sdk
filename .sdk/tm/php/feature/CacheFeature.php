...
// Accommodation SDK cache feature
...
class AccommodationCacheFeature extends AccommodationBaseFeature
{
    ...
    private function _through(AccommodationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
