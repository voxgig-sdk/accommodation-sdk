...
// Accommodation SDK ratelimit feature
...
class AccommodationRatelimitFeature extends AccommodationBaseFeature
{
    ...
    private function _acquire(AccommodationContext $ctx): void
    {
    ...
    private function _track(AccommodationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
