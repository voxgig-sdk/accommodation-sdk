...
// Accommodation SDK proxy feature
...
class AccommodationProxyFeature extends AccommodationBaseFeature
{
    ...
    public function init(AccommodationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AccommodationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
