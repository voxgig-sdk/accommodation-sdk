...
// Accommodation SDK utility: graphql
//
...
class AccommodationGraphql
{
    ...
    // equivalent.
    public static function body(AccommodationContext $ctx): mixed
    {
    ...
    public static function errors(AccommodationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
