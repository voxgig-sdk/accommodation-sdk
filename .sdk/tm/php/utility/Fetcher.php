...
class AccommodationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AccommodationSDK/1.0)';
    ...
    public static function call(AccommodationContext $ctx, string $fullurl, array $fetchdef): array
    {
