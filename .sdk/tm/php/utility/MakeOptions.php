...
// Accommodation SDK utility: make_options

class AccommodationMakeOptions
{
    ...
    public static function call(AccommodationContext $ctx): array
    {
        ...
        //
        // `AccommodationSchema::optspec()` is built from the model:
        ...
        $optspec = AccommodationSchema::optspec();
