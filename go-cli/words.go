...
func registerSDKWords(r *eng.Registry, client *sdk.AccommodationSDK) {
...
func runOp(client *sdk.AccommodationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
