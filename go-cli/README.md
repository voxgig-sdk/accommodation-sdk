...
AQL-driven CLI and REPL for the Accommodation SDK. Positional arguments are
...
./accommodation-cli load 1 accommodation
./accommodation-cli load '{id:1}' accommodation
