// Command Accommodation-cli is a CLI + REPL for the Accommodation SDK,
...
const prompt = "accommodation"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "accommodation"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ACCOMMODATION_APIKEY (api key), ACCOMMODATION_BASE (base url override)")
