...
module AccommodationTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("ACCOMMODATION_TEST_LIVE")
    override = getenv("ACCOMMODATION_TEST_OVERRIDE")
    ...
    explain = getenv("ACCOMMODATION_TEST_EXPLAIN")
    m["ACCOMMODATION_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = AccommodationTestRunner
Helpers = AccommodationHelpers
Vs = VoxgigStruct
