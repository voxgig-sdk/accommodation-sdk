...
#      offline in seeded test mode (AccommodationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Accommodation_sdk.rb")
  SDK_CLASS = "AccommodationSDK"
