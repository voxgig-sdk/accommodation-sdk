# Accommodation Ruby SDK Reference

Complete API reference for the Accommodation Ruby SDK.
...
#### `AccommodationSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Accommodation.list(nil)
```
