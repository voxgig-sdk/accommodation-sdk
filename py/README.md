...
The Python SDK for the Accommodation API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
result, err = client.Accommodation(None).list(None, None)
if err:
    raise Exception(err)
