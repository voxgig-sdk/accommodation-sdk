...
from accommodation_sdk.utility import register

# Load features
from accommodation_sdk.feature.base_feature import AccommodationBaseFeature
from accommodation_sdk.features import _has_feature, _make_feature
...
class AccommodationSDK:
    ...
    def get_utility(self):
        return AccommodationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AccommodationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Accommodation(self, data=None) -> "AccommodationEntity":
        ...
        from accommodation_sdk.entity.accommodation_entity import AccommodationEntity
