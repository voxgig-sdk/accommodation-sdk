...
from accommodation_sdk.accommodation_types import (
    Accommodation,
...
class AccommodationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AccommodationEntity(self._client, opts)
    ...
    def data_get(self) -> Accommodation:
    ...
    def match_get(self) -> Accommodation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Accommodation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Accommodation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
