# Accommodation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AccommodationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AccommodationSDK(...) and AccommodationSDK.test(...) become
#      AccommodationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "accommodation_sdk"
_SDK_CLASS = "AccommodationSDK"
